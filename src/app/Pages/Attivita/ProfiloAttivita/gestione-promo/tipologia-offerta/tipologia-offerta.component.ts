...
@Component({
  selector: 'app-tipologia-offerta',
  templateUrl: './tipologia-offerta.component.html',
  styleUrls: ['./tipologia-offerta.component.scss'],
})
export class TipologiaOffertaComponent  implements OnInit {
